...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8 mx-4">
        ...
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-6">Please check your email to reset your password.</p>
            <p class="text-gray-500 text-sm">Didn't receive the email? <a href="#" class="text-blue-600 hover:text-blue-800">Resend Password Reset link</a></p>
        </div>
    </div>
